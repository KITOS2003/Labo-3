...
def uplot(x, y):
    ...
    plt.errorbar(x_values, y_values, y_errors, x_errors, ".", color="orange")
...
class DatasetRC:
    ...
    def analisis_osc(self, ch1, ch2, fig_name="figure.pdf"):
        ...
        ajuste = lambda t, v0, ex, v_offset: v_offset + v0*np.exp(-ex * t)
        ...
        plt.plot(ch1[0], ch1[1], ".", color = "blue")
        plt.plot(ch2[0], ch2[1], ".", color = "orange")
...
class DatasetRL:
    ...
    def analisis_osc(self, ch1, ch2, fig_name="figure.pdf"):
        ...
        ch1 = ch1[:,cut_index:]
        ch2 = ch2[:,cut_index:]
        ajuste = lambda t, a, exp: a*(1-np.exp(-exp*t))
    ...
    def analisis(self):
        self.sort()
        ajuste_lineal = lambda x, a, b: a*x + b
...
resistencias = [ 100, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500 ]
resistencias = un.uarray(resistencias, [0]*len(resistencias))
